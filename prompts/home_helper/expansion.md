...
```
{
  "scenes": [
    {
      "scene_number": 1,
      "expanded_narrative": "135–155 words of child-facing story text. Prose with natural sprite dialogs. Always describe sprite at tiny scale. No stage directions."
    }
  ]
}
```
